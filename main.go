...
func main() {
	...
	log.Fatal(http.ListenAndServe(":8080", 
		handlers.CORS(
			handlers.AllowedOrigins([]string{"http://localhost:3000", "https://server-customer-tb-berkah-jaya-igcfjdj5fa-uc.a.run.app", "https://fe-tb-berkah-jaya-igcfjdj5fa-uc.a.run.app"}),
